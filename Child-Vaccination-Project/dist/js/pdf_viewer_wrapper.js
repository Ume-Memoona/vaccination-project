...
`;document.head.appendChild(template$5.content);function getTemplate$9(){return html`<!--_html_template_start_--><style include="pdf-shared">
  :host {
    display: contents;
  }
